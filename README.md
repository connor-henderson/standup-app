...
This is a text-only meditation library of freely available online content organized by author and source. The plan is to prioritize audio fed through a speech-to-text API (e.g., OpenAI Whisper) because that content is not yet available in text form.
